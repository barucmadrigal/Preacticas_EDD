...
/**
     ...
     /**
      * Metodo recursivo que devuelve el nodo en una posicion especifica de la lista.
      * 
      * @param i La posicion del nodo que se desea obtener.
      * @return El nodo ubicado en la posicion especificada.
      * @throws IllegalArgumentException Si la lista esta vacia o el indice es inválido.
      */
     public Nodo DevolverIndice(int i){
          ...
          if(i > longitud){
               throw new IllegalArgumentException("El indice no puede ser mayor");
          }
          ...
          if(i > 0){
               ListaDoblementeLigada<T> cola = new ListaDoblementeLigada<T>();
               cola.cabeza = this.cabeza.siguiente;
               i--; 
          }    
          return DevolverIndice(i);
